...
class Entity {
    public:
        ...
        constexpr bool operator==(const Entity& e) const { return id_ == e.id_; }
        constexpr bool operator!=(const Entity& e) const { return !(id_ == e.id_); }
        constexpr operator entity_type() const { return id_; }
        EntityData* operator->() const { return ECS::entity::data(id_); }
