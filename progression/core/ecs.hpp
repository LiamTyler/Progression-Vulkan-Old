...
#define REGISTER_COMPONENT_WITH_ECS( lua, Comp, assignPtr ) \
{ \
    using namespace entt; \
    auto reg_type = lua["registry"].get_or_create< sol::usertype< registry > >(); \
    ...
    auto V = lua.new_usertype< basic_view< entity, exclude_t<>, Comp > >( #Comp "_view" ); \
