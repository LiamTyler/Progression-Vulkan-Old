...
#define PG_DEBUG_MARKER_SET_FRAMEBUFFER_NAME( framebuffer, name ) Progression::Gfx::DebugMarker::SetFramebufferName( Progression::Gfx::g_renderState.device.GetHandle(), framebuffer.GetHandle(), PG_DEBUG_MARKER_NAME( "Framebuffer: ", name ) )
