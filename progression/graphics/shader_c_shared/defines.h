...
#define PG_SHADER_DEBUG_LAYER_AMBIENT 1
#define PG_SHADER_DEBUG_LAYER_DIFFUSE 2
#define PG_SHADER_DEBUG_LAYER_SPECULAR 3
#define PG_SHADER_DEBUG_LAYER_NO_SSAO 4
#define PG_SHADER_DEBUG_LAYER_SSAO_ONLY 5
